    ...
    class WhenGettingDeclaredPrograms {
      ...
      void shouldReturn200WhenDeclaredProgramsExistsAndBelongsToLoggedInStudent() {
        ...
        webTestClient
            ...
            .jsonPath("$.data[?(@.title == 'Stage développeur web')].description")
            .isEqualTo("Participation au développement d’une application web interne.")
            ...
            .jsonPath("$.data[?(@.title == 'Stage développeur web')].startDate")
            .isEqualTo("2024-02-01")
            .jsonPath("$.data[?(@.title == 'Stage développeur web')].endDate")
            .isEqualTo("2024-05-31")
