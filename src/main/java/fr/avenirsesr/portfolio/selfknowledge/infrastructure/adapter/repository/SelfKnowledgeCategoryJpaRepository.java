...
public interface SelfKnowledgeCategoryJpaRepository
    extends JpaRepository<SelfKnowledgeCategoryEntity, UUID>,
        JpaSpecificationExecutor<SelfKnowledgeCategoryEntity> {}
