...
import fr.avenirsesr.portfolio.trace.application.adapter.dto.AssociationTraceDTO;
...
public interface AssociationTraceMapper {
  static AssociationTraceDTO toDTO(AssociationTrace associationTrace) {
    return new AssociationTraceDTO(
        toDTO(associationTrace.skillLevelAssociation()),
        toDTO(associationTrace.additionalSkillAssociation()));
  }
