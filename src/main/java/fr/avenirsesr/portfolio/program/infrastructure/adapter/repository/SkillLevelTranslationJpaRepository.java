...
public interface SkillLevelTranslationJpaRepository
    extends JpaRepository<SkillLevelTranslationEntity, UUID>,
        JpaSpecificationExecutor<SkillLevelTranslationEntity> {}
