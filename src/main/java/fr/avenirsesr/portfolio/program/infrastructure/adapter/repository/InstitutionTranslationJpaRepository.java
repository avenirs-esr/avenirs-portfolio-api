...
public interface InstitutionTranslationJpaRepository
    extends JpaRepository<InstitutionTranslationEntity, UUID>,
        JpaSpecificationExecutor<InstitutionTranslationEntity> {}
