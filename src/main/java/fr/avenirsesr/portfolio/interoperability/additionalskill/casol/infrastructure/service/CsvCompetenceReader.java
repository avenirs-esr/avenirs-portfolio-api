...
import fr.avenirsesr.portfolio.interoperability.additionalskill.casol.domain.model.Category;
...
public class CsvCompetenceReader implements CompetenceReader {
  ...
  public List<Competence> readCompetences() {
    ...
    return FileReader.readCSV(
        "/additional-skill/casol/" + COMPETENCE_FILE,
        CSV_SEPARATOR,
        tokens ->
            new Competence(
  ...
  private List<Category> readCategories() {
    return FileReader.readCSV(
        "/additional-skill/casol/" + DOMAIN_FILE,
        CSV_SEPARATOR,
