...
public class AssociationServiceConfig {
  ...
  @Bean
  public AssociationService associationService(@Lazy List<AssociationStrategy> strategies) {
    return new AssociationServiceImpl(associationRepository, strategies);
  }
}
