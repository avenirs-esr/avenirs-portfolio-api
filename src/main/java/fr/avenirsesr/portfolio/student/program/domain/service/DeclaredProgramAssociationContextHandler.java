...
public class DeclaredProgramAssociationContextHandler implements AssociationContextHandler {
  ...
  private List<DeclaredProgram> fetchAndCheckOwnership(List<UUID> elementIds) {
