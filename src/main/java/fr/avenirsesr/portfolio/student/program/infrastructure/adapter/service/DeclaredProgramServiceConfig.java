...
import fr.avenirsesr.portfolio.student.program.domain.service.DeclaredProgramAssociationStrategy;
...
public class DeclaredProgramServiceConfig {
  ...
  @Bean
  public AssociationStrategy declaredProgramAssociationStrategy() {
    return new DeclaredProgramAssociationStrategy(declaredProgramService(), loggedInUserService);
  }
}
