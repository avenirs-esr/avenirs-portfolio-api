...
public class Notification extends AvenirsBaseModel {
  ...
  public static Notification create(
    ...
    return new Notification(UUID.randomUUID(), now, now, type, elementId, user, parameters, false);
  }
  ...
  public static Notification toDomain(
      ...
      List<String> parameters,
      boolean seen) {
    return new Notification(id, createdAt, updatedAt, type, elementId, user, parameters, seen);
  }
}
